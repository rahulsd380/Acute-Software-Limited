...
const Footer = () => {
  return (
    <div className="mt-20">
      <div className="w-full  bg-blue-900 bg-opacity-20 border-t border-blue-800 ">
        <section className="  ">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 mt-24 text-bodytext">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 pb-14 border-b-2 border-gray-200">
              <div className="flex flex-col gap-8 xl:gap-14 w-full lg:max-w-full mx-auto">
                <div className="flex flex-col gap- space-y-2">
                  {/* <img className="w-[50px]" src={logo} alt="" /> */}
                  <h2 className="font-manrope font-bold text-4xl leading-snug text-bodytext max-[470px]:text-center">
                    Begin Your Project <br />
                    Journey, With Us!
                  </h2>
                  <p className="text-base font-normal text-bodytext max-[470px]:text-center">
                    Take the First Step Towards Success!
                  </p>
                  <div className="flex items-center max-[470px]:justify-center gap-5">
                    <a
                      href="javascript:;"
                      className="p-2 text-bodytext rounded transition-all duration-500 hover:bg-bodytext focus-within:bg-yellow-800 hover:text-black focus-within:outline-0 focus-within:text-white"
                    >
                      <svg
                    ...
                    <a
                      className="p-[11px] text-bodytext rounded transition-all duration-500 hover:bg-bodytext focus-within:bg-yellow-800 hover:text-black focus-within:outline-0 focus-within:text-white"
                      href=""
                    >
                ...
                <div className="flex  flex-col min-[470px]:flex-row min-[470px]:items-center gap-3">
                  <button className="flex items-center max-[470px]:justify-center gap-2 py-3 pr-5 pl-7 rounded-full text-base font-semibold text-white bg-blue-800 shadow-transparent shadow-sm transition-all duration-500 hover:shadow-blue-300 hover:bg-black">
                    Start Project
                  </button>
                  <button className="flex items-center max-[470px]:justify-center gap-2 border-2 border-blue-800 py-2.5 pr-5 pl-7 rounded-full text-base font-semibold text-black bg-white shadow-transparent shadow-sm transition-all duration-500 hover:shadow-blue-300 hover:bg-black hover:text-white ">
                    Contact Us
                  </button>
                </div>
              </div>
              <div className="w-full lg:max-w-full mx-auto flex flex-col min-[470px]:flex-row justify-between gap-6 sm:gap-20 md:gap-10 xl:gap-24">
                <div className="">
                  <h6 className="text-lg font-medium text-bodytext mb-7 max-[470px]:text-center">
                    Pages
                  </h6>
                  <ul className="flex flex-col max-[470px]:items-center max-[470px]:justify-center gap-3">
                    <li>
                      <a
                        href=""
                        className="text-base font-normal max-lg:text-center text-bodytext whitespace-nowrap transition-all duration-300 hover:text-blue-500 focus-within:outline-0 focus-within:text-yellow-800"
                      >
                        Home
                      </a>
                    </li>
            ...
            <div className="flex flex-col-reverse gap-5 sm:flex-row items-center first-letter:items-center justify-between pt-4 pb-6">
              <p className="font-normal text-sm text-bodytext">
                ©All right reserved by Accute Software Solution
              </p>
              <ul className="flex items-center gap-9">
                <li>
                  <a
                    href="javascript:;"
                    className="text-bodytext text-sm font-normal transition-all duration-300 hover:text-blue-500 focus-within:outline-0 focus-within:text-yellow-800"
                  >
                    Terms
                  </a>
                </li>
...
// Have to use logo in footer
// Have to remove those buttons
// The headings will be bold
// In place of resource, comnapy contact info will come